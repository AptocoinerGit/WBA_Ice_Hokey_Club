...
# Your download URL
url = "https://appload.scopevisio.com/datasource/giydinbuhe4s6mjxf52xgzlsl42demjtmjqtcmjnmmzdcmzngqydonjnhfstkzbngjtdozjrgbsggmlggnsc6ojymm2ggytegqwwcnddmewtiyrwgqwwenlfgqwwcmrzgnsdmmbzgzqwioa/Debitor_everything.html"
...
if response.status_code == 200:
    ...
    spark.createDataFrame(df).write.mode("overwrite").saveAsTable("Debitor_everything")
