...
# Your download URL
url = "https://appload.scopevisio.com/datasource/giydinbuhe4s6mjxf52xgzlsl42demjtmjqtcmjnmmzdcmzngqydonjnhfstkzbngjtdozjrgbsggmlggnsc6nrxguzdkyjxmiwtazrqhawtimlemywweyrrmewtenbzmfsteztbmu2dmyi/Everything.html"
...
if response.status_code == 200:
    ...
    spark.createDataFrame(df).write.mode("overwrite").saveAsTable("Everything")
