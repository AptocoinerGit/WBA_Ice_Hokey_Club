...
# Your download URL
url = "https://appload.scopevisio.com/datasource/giydinbuhe4s6mjxf52xgzlsl42demjtmjqtcmjnmmzdcmzngqydonjnhfstkzbngjtdozjrgbsggmlggnsc6zrrmy4tkntcgiwwczjugywtizdgg4wwczjrgewwimjvmjrwgyrxga3weoi/OPOS_everything.html"
...
if response.status_code == 200:
 ...
 # 🧹 Clean column names (remove spaces and invalid chars)
    ...
    spark.createDataFrame(df).write.mode("overwrite").saveAsTable("OPOS_everything")
