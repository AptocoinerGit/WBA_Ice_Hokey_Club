...
# Your download URL
url = "https://appload.scopevisio.com/datasource/giydinbuhe4s6mjxf52xgzlsl42demjtmjqtcmjnmmzdcmzngqydonjnhfstkzbngjtdozjrgbsggmlggnsc6mleg4zdsyzyg4wtqnbqgywtizrzgewtsn3dg4wwimtfmjrtgmzqmuzwcyq/kreditor_everything.html"
...
if response.status_code == 200:
    ...
    try:
        ...
        # Sometimes the link returns an HTML table
    ...
    spark.createDataFrame(df).write.mode("overwrite").saveAsTable("kreditor_everything")
